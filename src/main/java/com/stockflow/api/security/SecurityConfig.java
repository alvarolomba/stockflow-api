...
public class SecurityConfig {
    ...
    public SecurityConfig(@Value("${app.cors.allowed-origins}") String allowedOrigins) {
        this.allowedOrigins = new ArrayList<>(Arrays.stream(allowedOrigins.split(","))
                ...
                .toList());
        this.allowedOrigins.add("https://stock-flow-dashboard.vercel.app");
        this.allowedOrigins.add("https://stock-flow-dashboard-two.vercel.app");
        this.allowedOrigins.add("https://stockflow-dashboard-two.vercel.app");
        this.allowedOrigins.add("https://stockflow-dashboard.vercel.app");
    }
